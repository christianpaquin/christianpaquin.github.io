...
Finally, Dan Boneh, Xavier Boyen, and Hovav Shacham created the pairing-based BBS signature scheme, which after a few updates (including ideas from Camenisch and Lysyanskaya) became the basis for the current BBS specification.[^3]
